...
export default function WhatsAppFloat() {
  ...
  return (
    <button
      onClick={handleClick}
      className="fixed bottom-6 ltr:right-6 rtl:left-6 z-50 p-4 bg-[#25D366] text-white rounded-full shadow-2xl hover:scale-110 transition-transform active:scale-95 flex items-center justify-center gap-2 group"
